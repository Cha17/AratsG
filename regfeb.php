...
<html lang="en">
  ...
  <body
  class="min-h-screen relative bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200">
    <!-- Gradient Background -->
        ...
        <div class="flex flex-col items-stretch px-10 pt-48">
          ...
          <!-- First Row Info -->
            ...
            <div class="justify-between mt-10 max-md:max-w-full">
              <div
                class="gap-14 flex max-md:flex-col max-md:items-stretch max-md:gap-0"
              >
              <!-- Year -->
              <div
                  class="flex flex-col items-stretch w-[33%] max-md:w-full max-md:ml-0"
                  ...
                  <div class="items-stretch flex grow flex-col max-md:mt-10">
                    ...
                    >
                      <select
                        ...
                        class="bg-[#eff0f2] mt-3 py-3 px-5 w-full border border-gray-300 focus:outline-none focus:ring-[#ab644d] focus:ring-1 rounded-[50px] max-md:pl-1"                        autocomplete="off"
                        >
                        <option value=""></option>
...
<!-- component -->
          ...
          <section class="mb-20">
            <div class="flex flex-col items-stretch px-16">
              ...
              >
        <button type="submit"
              name="submit" class="bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 justify-center items-center shadow-2xl flex w-[200px] max-w-full gap-2 mt-6 px-12 py-5 rounded-[40px] self-center max-md:mt-10 max-md:px-5">
