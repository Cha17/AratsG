...
<html lang="en">
  ...
  <body>
    <!-- Gradient Background -->
    <div
      class="blob w-full h-full rounded-[999px] absolute top-0 right-0 -z-10 blur-3xl bg-opacity-60 bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200"
    ></div>
    <div
    ...
    <div class="flex flex-col items-stretch pl-12 pr-12 max-md:px-5">
      ...
      >
        ...
        >
          <div
            class="flex-col overflow-hidden relative flex w-full items-stretch px-6 pt-7 pb-9"
          >
            <div class="relative flex items-stretch justify-between gap-2">
              <div
                class="bg-sky-900 flex w-1 shrink-0 h-[23px] flex-col rounded-3xl"
              ></div>
              <h2
                class="text-gray-950 text-xl font-medium leading-7 grow whitespace-nowrap self-start"
              >
                Feb-Ibig 2024
              </h2>
            </div>
        ...
        <div
          class="bg-gradient-to-tl from-transparent hover:from-[#FFFFFF] hover:via-[#e7be6e] hover:to-[#fc8044] self-stretch w-[250px] max-w-[250px] h-[330px] max-h-[330px] flex grow basis-0 flex-col items-stretch py-px rounded-xl"
        >
          <div
            class="flex-col overflow-hidden relative flex w-full items-stretch px-6 pt-7 pb-12"
          >
            <div class="relative flex items-stretch justify-between gap-2">
              <div
                class="bg-sky-900 flex w-1 shrink-0 h-[23px] flex-col rounded-3xl"
