...
<body>
  ...
  <div class="carousel">
    ...
    <div class="list">
      <div class="item">
        <img src="<?php echo $row['image']?>" alt="Feb-Ibig 2024" />
        <div class="content">
          <div class="contentContainer">
            ...
            <div class="buttons">
              <button type="button">
                <?php echo '<a href="register.php?column=event_id&evalue='.$row['event-id'].'">Register</a>'?>
              </button>
            </div>
          </div>
        </div>
    ...
    <div class="thumbnail">
      <div class="item">
        <img src="<?php echo $row['image']?>" alt="Biniverse" class="border-solid border-2 border-slate-500" />
        <div class="content">
